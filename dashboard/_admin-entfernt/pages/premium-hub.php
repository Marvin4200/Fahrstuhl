...
<div class="hub-grid">
    ...
    <a class="hub-card" href="<?php echo BASE_URL; ?>/pages/guild-premium.php">
        <h3>👑 Server-Plan vergeben</h3>
        <p>Premium für einen ganzen Server aktivieren oder entziehen.</p>
        <strong>Server-Entitlements</strong>
    </a>
    <a class="hub-card" href="<?php echo BASE_URL; ?>/pages/monetization-health.php">
        <h3>🩺 Monetization Health</h3>
        <p>Warnungen zu Promos, Ablaufdaten und Einlösungen.</p>
        <strong>Read-only Checks</strong>
    </a>
    <a class="hub-card" href="<?php echo BASE_URL; ?>/pages/rewards-hub.php">
        <h3>🎁 Rewards</h3>
        <p>Votes, Shields und Belohnungen.</p>
        <strong><?php echo formatNum($voteSummary['votes24h'] ?? 0); ?> votes 24h</strong>
    </a>
</div>
