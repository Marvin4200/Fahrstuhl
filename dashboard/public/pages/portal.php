...
$starterActions = array_values(array_filter([
    [
        ...
        'copy' => $selectedGuild
            ? 'Aktiv: ' . $selectedGuild['name'] . '. Alle Einstellungen gelten jetzt für diesen Server.'
            : 'Wähle zuerst den Server unten aus. Ohne Auswahl fuehlen sich Menues chaotisch an.',
        'href' => BASE_URL . '/pages/portal.php',
        'label' => $selectedGuild ? 'Server wechseln' : 'Server wählen',
    ],
    [
...
<div class="pt-container">
    ...
    <div class="pt-warning-bar" id="health-check">
        <?php if ($selectedGuildId === ''): ?>
            <div>
                <strong>Info: Kein Server gewählt</strong>
                <p>Wähle unten einen Server, damit Health-Hinweise geladen werden.</p>
            </div>
            ...
            <?php if (empty($portalActiveModules)): ?>
                <div class="dashboard-list-item">
                    <div>
                        ...
                        <p>Starte mit Welcome, Logging oder Tickets für einen sauberen Grundaufbau.</p>
                    </div>
                </div>
            <?php else: ?>
