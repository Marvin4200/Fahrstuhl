...
<section class="dashboard-page-header">
    <div class="dashboard-page-copy">
        ...
        <h1>Social Alerts</h1>
        <p>Postet Updates für <?php echo esc($guildName); ?> bei neuen Uploads, Streams oder RSS-Einträgen.</p>
    </div>
...
<?php endif; ?>
    <div class="social-panel">Bitte zuerst einen Server auswählen.</div>
<?php else: ?>
<form id="socialForm" method="POST" class="social-shell">
    ...
    <aside class="social-panel social-preview">
        ...
        <p class="social-muted">Beim ersten Speichern merkt sich der Bot nur den neuesten Stand. Erst neue Uploads, neue RSS Einträge oder neue Twitch Streams werden gepostet.</p>
    </aside>
</form>
<?php endif; ?>
