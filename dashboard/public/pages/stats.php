...
<div class="sa-wrap">
    ...
    <?php if (empty($guildId) || empty($data)): ?>
        <div class="sa-empty empty-state">
            ...
            <p>Wähle einen Server aus oder aktiviere zuerst zentrale Module wie Leveling, Tickets und Moderation.</p>
            <a class="btn-icon cta btn-secondary-ui" href="modules.php?guildId=<?php echo urlencode($guildId); ?>">Module öffnen</a>
        </div>
    <?php else: ?>
        ...
        <div class="sa-sections">
            <div class="sa-panel">
                ...
                <div>
                    ...
                    <div class="sa-empty">Aktuell werden dafür noch keine historischen Zeitreihen gespeichert. Die Seite zeigt deshalb bewusst einen leeren Zustand statt fehlerhafter Fake-Daten.</div>
                </div>
            </div>
            ...
            <div class="sa-panel">
                ...
                <div style="margin-bottom:0.9rem;">
                    ...
                    <div class="sa-list">
                        ...
                        <?php if (empty($activeChannels)): ?>
                            <div class="sa-empty">Noch keine Channel-Aktivität vorhanden.</div>
                        <?php else: ?>
                ...
                <div>
                    ...
                    <div class="sa-list">
                        ...
                        <?php if (empty($recent)): ?>
                            <div class="sa-empty">Noch keine Moderation-Aktivität vorhanden.</div>
                        <?php else: ?>
