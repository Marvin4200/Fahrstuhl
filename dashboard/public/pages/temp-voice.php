...
<div class="tv-head">
    <div class="tv-title">
        <h1>Temp Voice</h1>
        <p>Erstellt automatisch private Voice-Channels für <strong><?php echo esc($guildName); ?></strong>, wenn User dem Hub beitreten.</p>
    </div>
    <form method="GET">
...
<?php if (!$guildId): ?>
    <div class="tv-panel">Bitte zuerst einen Server auswählen.</div>
<?php else: ?>
    ...
    <section class="tv-panel">
        <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:1rem;">
            <div>
                ...
                <p style="margin:.25rem 0 0;color:var(--text-secondary);">Hub wählen, Vorlage setzen, speichern, fertig.</p>
            </div>
        ...
        <div class="tv-grid">
            ...
            <div class="tv-field">
                <label>Kategorie für neue Channels</label>
        ...
        <div class="tv-checks">
            ...
            <label class="tv-check"><input type="hidden" name="deleteWhenEmpty" value="0"><input type="checkbox" name="deleteWhenEmpty" value="1" <?php echo checkedAttr($settings['deleteWhenEmpty'] ?? true); ?>> Leere Channels löschen</label>
        </div>
